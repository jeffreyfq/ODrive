...
void HAL_ADC_MspInit(ADC_HandleTypeDef* adcHandle)
{
  ...
  /* USER CODE END ADC1_MspInit 0 */
    ...
    PC5     ------> ADC1_IN15 
    */
    GPIO_InitStruct.Pin = M0_IB_Pin|M0_IC_Pin|VBUS_S_Pin|MOTOR_TEMP_Pin 
                          |M0_TEMP_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(GPIOC, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = EXT_ANALOG_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_PULLDOWN;
    HAL_GPIO_Init(EXT_ANALOG_GPIO_Port, &GPIO_InitStruct);
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* adcHandle)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PC5     ------> ADC1_IN15 
    */
    HAL_GPIO_DeInit(GPIOC, M0_IB_Pin|M0_IC_Pin|VBUS_S_Pin|MOTOR_TEMP_Pin 
                          |M0_TEMP_Pin);

    HAL_GPIO_DeInit(EXT_ANALOG_GPIO_Port, EXT_ANALOG_Pin);
